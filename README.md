![Primary Simplified in Obsidian](./assets/primary-simplified-checkboxes-callouts.png)
...
- local bundled fonts, so the theme works offline
...
The `snippets/` folder contains extra CSS that is useful for some vaults but too
specific to ship as always-on theme behavior.

Available snippets:

- [`primary-decimal-lists.css`](./snippets/primary-decimal-lists.css) for nested decimal lists such as `1.1.1`
- [`primary-checkbox-icons.css`](./snippets/primary-checkbox-icons.css) for extra task-state styling
- [`primary-callout-showcase.css`](./snippets/primary-callout-showcase.css) for additional callout aliases
- [`primary-calendar-plugin.css`](./snippets/primary-calendar-plugin.css) for the Calendar plugin
- [`primary-kanban-plugin.css`](./snippets/primary-kanban-plugin.css) for the Kanban plugin
- [`primary-custom-icons-lite.css`](./snippets/primary-custom-icons-lite.css) for small icon refinements

To use a snippet, copy the `.css` file into `<vault>/.obsidian/snippets/`, then
