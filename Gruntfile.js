...
module.exports = function(grunt) {
    grunt.initConfig({
        ...
        */
        ...
        /*  Concatenate CSS files to include license, README,
            and style settings inside the CSS to produce the
            single distributable theme.css   */
        concat_css: {
            dist: {
                files: {
                    'theme.css': [
        ...
        watch: {
            css: {
                ...
                tasks: ['env', 'loadenv', 'sass:unminified', 'sass:minified', 'cssmin', 'concat_css', 'copy']
            }
        }
    });
    ...
    /*  build command: one-shot, deterministic compile of theme.css
